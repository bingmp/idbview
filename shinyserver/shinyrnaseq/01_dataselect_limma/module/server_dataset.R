    ...
    function(input, output, session) {
      ...
      observeEvent(input$show_gse, {
          ...
          observe({
              ...
              observeEvent(input$show_learning_data, { 
                ...
                observeEvent(input$submit_data, {
                  saveRDS(mydata(),file = '~/ShinyApps/shinyserver/shinyrnaseq/data/select_limma_myexp.RDS')
                  saveRDS(mygroup(),file = '~/ShinyApps/shinyserver/shinyrnaseq/data/select_limma_mygroup.RDS')
                })
       ...
       observeEvent(input$remove_data, { 
         file.remove('~/ShinyApps/shinyserver/shinyrnaseq/data/select_limma_myexp.RDS')
         file.remove('~/ShinyApps/shinyserver/shinyrnaseq/data/select_limma_mygroup.RDS')
      }) 
