...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    # choose province
    conditionalPanel(
      '["China", "South Korea", "United States", "Japan", "Iran", "Italy", "Germany", "United Kingdom"].indexOf(input.country) > -1',
  ...
  dashboardBody(
    ...
    fluidRow(
      # data table
      box(
        title = downloadButton("dataDownload", "Data Table"),
        solidHeader = T,
        width = 4,
        collapsible = T,
    ...
    fluidRow(
      tabBox(
        ...
        tabPanel("Growth Rate", plotOutput("growth_rate")),
        tabPanel(
          "Forecast",
          fluidPage(
    ...
    tags$a(
      href = "https://github.com/GuangchuangYu/nCov2019", target = "_blank",
